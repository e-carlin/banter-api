...
public class AccountController {
    ...
    public void addAccount(@Valid @RequestBody AddAccountRequest addAccountRequest) throws ConstraintViolationException, PlaidExecuteExchangePublicTokenException {
        throw new PlaidExecuteExchangePublicTokenException("Evan threw this!!!!!!"); //TODO: Delete
...
//            response = plaidClientService.exchangPublicToken(addAccountRequest.getPublicToken());
...
//            try {
//                response = plaidClientService.getService().accountsBalanceGet(
